...
#    Then I expect the response to match "<response>"
  ...
  Examples:
    ...
    |1492-J239-10|COMPAS    |inputFiles/inputFile1.json|expectedFiles/expectedFile_100.json            |201        |Email Ind false|
    |1492-J607-10|COMPAS    |inputFiles/inputFile2.json|expectedFiles/expectedFile_100.json            |201        |Email Ind true |
